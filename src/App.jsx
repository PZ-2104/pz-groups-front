			...
			<div>
				...
				<div className="team-description">
					...
					<p className="description">
						...
						commitment to achieving high results in the field of information technology. We not only learn,
						but
						also actively apply our knowledge to create innovative solutions that contribute to the
						development
					...
					<div className="text-photo">
						<div className="text-photo-1">
							<div className="team-text-1">
								<p>
									We support each other, we love what we do, and we’re really good at it. That’s why
									we’ve
									been able to attract the best people in UX/UI design, motion graphics, mobile tech,
									project management, and quality assurance. It’s also why the size of our team
									doubles
									every two years. But it’s not summer camp. Our staff are professionals who can and
									often
									do work closely with our clients’ own developers. Delivering on time and on spec is
									just
									a matter of course.
								</p>
							</div>
				...
				<div className="our-projects">
					...
					<div className="project-cards">
						<Link to="src/components/Project1.jsx" className="project-card-1">  {/* Wrap with Link */}
							<img src={ProjectImage} alt="Project"/>
							<h3>Expenses Tracker</h3>
							<p>Finance, Tracker, Money</p>
						</Link>
						<Link to="src/components/Project2.jsx" className="project-card-2">  {/* Wrap with Link */}
							<img src={ProjectImage} alt="Project"/>
							<h3>Expenses Tracker</h3>
							<p>Finance, Tracker, Money</p>
						</Link>
						<Link to="src/components/Project3.jsx" className="project-card-3">  {/* Wrap with Link */}
							<img src={ProjectImage} alt="Project"/>
							<h3>Expenses Tracker</h3>
							<p>Finance, Tracker, Money</p>
						</Link>
						<Link to="src/components/Project4.jsx" className="project-card-4">  {/* Wrap with Link */}
							<img src={ProjectImage} alt="Project"/>
							<h3>Expenses Tracker</h3>
							<p>Finance, Tracker, Money</p>
						</Link>
