	...
	return (
		<div>
			...
			<div className="team-description">
				...
				<p className="description">Our group of students at the university is characterized by a high level of enthusiasm and commitment to achieving high results in the field of information technology. We not only learn, but also actively apply our knowledge to create innovative solutions that contribute to the development of the university environment and enrich the learning experience.</p>
			</div>
			<div className="about-team">
				...
				<div className="text-photo">
					...
					<div className="team-text-1">
						<p>We support each other, we love what we do, and we’re really good at it. That’s why we’ve been able to attract the best people in UX/UI design, motion graphics, mobile tech, project management, and quality assurance. It’s also why the size of our team doubles every two years. But it’s not summer camp. Our staff are professionals who can and often do work closely with our clients’ own developers. Delivering on time and on spec is just a matter of course.</p>
					</div>
